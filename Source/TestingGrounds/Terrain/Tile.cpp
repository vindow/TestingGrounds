...
{
	TArray<FSpawnPosition> SpawnPositions = GenerateSpawnPositions(SpawnParameters);
...
TArray<FSpawnPosition> ATile::GenerateSpawnPositions(FRandomSpawnParameters SpawnParameters)
{
